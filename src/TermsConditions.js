...
function TermsConditions(){
  document.title ="Marhansolutions - Terms Conditions"
  useEffect(() => {
    Aos.init({
        offset: 100,
        easing: 'ease',
    ...
    return(
        <>
        <SubPageBanner name="Terms & Conditions" indexpage="Home" indexvisit="/" activepage="Terms Conditions"
        img="images/privacy-police.webp" />
        <section className="total-body pt-3 d-block">
           <div className="pripacy-p trems-page mb-5">
             <div className="container">
                ...
                <div class="comon-part-trm">
                 ...
                 <div class="comon-part-trm">
                   ...
                   <h5> Cookies </h5>
                   <ul>
                    <li> <i class="far fa-dot-circle"></i> <span> If you leave a comment on our site, you may opt into saving your name, email address, and website in cookies. These are for your convenience so that you do not have to fill in your details again when you leave another comment. These cookies will last for one year.</span>  </li>
                    <li> <i class="far fa-dot-circle"></i> <span> If you visit our login page, we will set a temporary cookie to determine if your browser accepts cookies. This cookie contains no personal data and is discarded when you close your browser. </span>  </li>
                    <li> <i class="far fa-dot-circle"></i> <span> When you log in, we will also set up several cookies to save your login information and your screen display choices. Login cookies last for two days, and screen options cookies last for a year. If you select “Remember Me”, your login will persist for two weeks. 
                      If you log out of your account, the login cookies will be removed.</span>  </li>
                    <li> <i class="far fa-dot-circle"></i> <span> If you edit or publish an article, an additional cookie will be saved in your browser. This cookie includes no personal data and simply 
                      indicates the post ID of the article you just edited. It expires after one day.</span>  </li>
                    <li> <i class="far fa-dot-circle"></i> <span> Embedded content from other websites
                        Articles on this site may include embedded content (e.g. videos, images, articles, etc.). Embedded content from other websites behaves in the exact same way as if the visitor has visited the other website.
                        </span>  </li>
                    <li> <i class="far fa-dot-circle"></i> <span>These websites may collect data about you, use cookies, embed additional third-party tracking, and monitor your interaction with that embedded content, including tracking your interaction with 
