...
import AllWorks from "./PortolioApi";
...
function Protfoilowork(){
    const [ items , setItems] =useState(AllWorks);
    const filterItems = (cateItem) => {
        const updatedItems = AllWorks.filter((curElem) => {
    ...
    return(
        ...
        <div className="controls mt-3 mb-5 d-flex flex-column flex-sm-row justify-content-md-end">
            ...
            <ul className="fiter-btn list-unstyled filter-menu-q d-flex justify-content-center">
                <li className="active">
                <button type="button"  className="filter btn" onClick={ () => setItems(AllWorks)}>All</button>
                </li>
                <li>
                            ...
                            return(
                                ...
                                <div className="col mix category-6">
                                    ...
                                    <div className="cm-port">
                                        <button data-fancybox="portwork" data-src={imgname}  data-aos="fade-up">
                                                <figure>
