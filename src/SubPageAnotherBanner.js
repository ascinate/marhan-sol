...
function SubPageAnotherBanner(props){
    useEffect(() => {
        Aos.init({
            offset: 100,
            easing: 'ease',
    ...
    return(
        <>
        <section className="sub-page-banner new-add sub-banner left-banner">
                ...
                <div className="container">
                    ...
                    <div className="row align-items-center">
                        ...
                        <button type="button" className="buy-now-btn" name="button">  Get A Free Quote 
...
export default SubPageAnotherBanner;