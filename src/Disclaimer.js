...
function Disclaimer(){
  document.title ="Marhansolutions - Disclaimer"
  useEffect(() => {
    Aos.init({
        offset: 100,
        easing: 'ease',
    ...
    return(
        <>
        <SubPageBanner name="Disclaimer" indexpage="Home" indexvisit="/" activepage="Disclaimer"
        img="images/guid-ecom-portofilo.png" />
